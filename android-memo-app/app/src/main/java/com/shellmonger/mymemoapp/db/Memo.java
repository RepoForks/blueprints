...
/**
 * Model for the Memo items loaded to/from the database
 */
public class Memo implements Serializable {
    ...
    /**
     * The Date Format used to display the time when in the list view
     */
    ...
    /**
     * Gets a shortened version of the text suitable for display in a list screen
